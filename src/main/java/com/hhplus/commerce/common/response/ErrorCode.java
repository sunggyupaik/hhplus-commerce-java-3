...
public enum ErrorCode {
    ...
    PAYMENT_NOT_FOUND(HttpStatus.NOT_FOUND.value(), "존재하지 않는 결제입니다."),
    ...
    //redisson
    LOCK_NOT_AVAILABLE(HttpStatus.CONFLICT.value(), "락을 획득할 수 없습니다."),
    LOCK_INTERRUPTED_ERROR(HttpStatus.CONFLICT.value(), "인터럽트로 락을 획득할 수 없습니다."),
